...
su - $LINUX_USERNAME -c 'DISPLAY= /opt/google/chrome-remote-desktop/start-host --code="4/0AeaYI_xxxxxxxxxxxxxxxxxxxxx" --redirect-url="https://remotedesktop.google.com/_/oauthredirect" --name=$(hostname) --pin=123456'
